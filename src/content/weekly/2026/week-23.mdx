...
stuff. Hence, I did ask a couple of experts who're well-versed with GPU stuff, and prepared a 
...
I knew how to do some `gcc abc.cpp -abc`, but I needed to get a hold of some compiler flags for 
tooling + debugging.
