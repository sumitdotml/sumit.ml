...
The frozen interpretation rule  how that mean gap can be read. A condition mean gap below `0.01` accuracy was to be reported as inconclusive rather than as a winner. The observed mean gap was `0.0045489006823352`, so I treated the result as directional evidence under this setup, not as a general claim that attention-only LoRA is better. 
